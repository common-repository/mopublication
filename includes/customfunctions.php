...
function mopub_str_img_src($html) {
...
function mopub_cleanContent($content, $comment = false) {
...
function mopub_cleanContentDemo($content) {
...
function mopub_cleanContentStrict($content) {
...
function mopub_cleanGeneral($content) {
...
function mopub_getSystemTabs() {
    ...
    $systemPages[8]['ID']       = 'bookmarks';
    $systemPages[8]['name'] 	= 'Bookmarks';
    $systemPages[8]['wordID']   = 'Bookmarks';
    $systemPages[8]['type'] 	= 'system';
    $systemPages[8]['icon'] 	= 'bookmarks';
    
    return $systemPages;
    
}

function mopub_addToTabsOrder($tabsArray) {
...
function mopub_tabInArray($needle, $haystack) {
...
function mopub_removeTabFromOrder($key, $value) {
...
function mopub_getPermalinkStructure() {
