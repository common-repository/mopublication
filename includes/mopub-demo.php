...
<div class="demo_body">
    ...
    $demo_article_count ++;
        ...
        if(empty($thumbnail)) {
            $matchDemoImages = mopub_str_img_src($post->post_content);
    ...
    <div class="demo_article demo_article_<?php echo $demo_article_count; ?>">
        ...
        <div class="demo_post_content">
            ...
            <div class="paragraph"><?php echo substr(mopub_cleanContentDemo($post->post_content), 0, 55); ?></div>
