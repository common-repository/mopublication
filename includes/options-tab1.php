...
<div class="frm_row">
    ...
    <div class="frm_right">
        ...
        <input id="frm_topbar_logo_min_width" type="hidden" value="620"/> 
        <input id="frm_topbar_logo_min_height" type="hidden" value="88"/>
        <?php //<input id="frm_images_logo_allowed_types" type="hidden" value="png, jpg, jpeg"/> ?>
...
<div class="frm_row">
    ...
    <div class="frm_right">
        <?php /*<input id="frm_images_appicon_allowed_types" type="hidden" value="png, jpg, jpeg"/>*/ ?>
