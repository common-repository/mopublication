...
<MoPublication_config>
    ...
    <addthis_share_url><![CDATA[<?php echo mopub_getPermalinkStructure() . 'type=share&article_id='; ?>]]></addthis_share_url>
    ...
    ?>]]></ipad_launch_ad>
    <ad_type><?php echo get_option('frm_ad_status'); ?></ad_type>
    
    <!-- Top Navigation Bar -->
    <?php $navbar = mopub_hex2rgb(get_option('frm_topbar_background'));?>
    ...
    <!-- Sections Bar -->
    <?php $sections = mopub_hex2rgb(get_option('frm_menu_background_color')); ?>
    ...
    <?php $sections_inactive = mopub_hex2rgb(get_option('frm_menu_textcolor_inactive')); ?>
    ...
    <?php $sections_active = mopub_hex2rgb(get_option('frm_menu_textcolor')); ?>
    ...
    <?php $sections_active_background = mopub_hex2rgb(get_option('frm_menu_active_background_color')); ?>
    ...
    <!--content-->
    <?php $listingBackground = mopub_hex2rgb(get_option('frm_viewer_background'));?>
    ...
    <!--Border-->
    <?php $listingBorder = mopub_hex2rgb(get_option('frm_border_color'));?>
    ...
    <!-- Colors -->
    <?php $listing_headline = mopub_hex2rgb(get_option('frm_type_title_color')); ?>
    ...
    <?php $listing_abstract = mopub_hex2rgb(get_option('frm_type_text_color')); ?>
    ...
    <?php $listing_pubdate = mopub_hex2rgb(get_option('frm_type_meta_color')); ?>
    ...
    <?php $link = mopub_hex2rgb(get_option('frm_type_link_color')); ?>
    ...
    <!-- Feeds -->
    <search_feed><![CDATA[<?php echo mopub_getPermalinkStructure().'type=search&querystring='; ?>]]></search_feed>
    <search_view_feed><![CDATA[<?php echo mopub_getPermalinkStructure().'type=article&article_id='; ?>]]></search_view_feed>
           ...
           if(!empty($element)) {
                if (get_option('frm_cat_checkbox_' . str_replace(" ", "-", $element))) {
                        ...
                        if($element == 'all') {
                            ...
                            echo mopub_getPermalinkStructure().'type=cat&cat=';
                            ...
                            if ($keyInner === key($cleanCat_arr)) {
                                    echo mopub_getPermalinkStructure().'type=cat&cat='.urlencode($element);
                            } else {
                                    echo '|'.mopub_getPermalinkStructure().'type=cat&cat='.urlencode($element);
                            }
        ...
        foreach ($cat_arr as $keyInner => $element)
        {
          if(!empty($element)) {
                if (get_option('frm_cat_checkbox_' . str_replace(" ", "-", $element))) {
                  ...
                  echo mopub_getPermalinkStructure(). 'type=article&article_id=';
    ...
    <category_listing_feed><![CDATA[<?php echo mopub_getPermalinkStructure().'type=cat_list'; ?>]]></category_listing_feed>

    <topic_listing_feed><![CDATA[<?php echo mopub_getPermalinkStructure().'type=tag_list'; ?>]]></topic_listing_feed>
    ...
    <video_listing_feed><![CDATA[<?php echo mopub_getPermalinkStructure().'type=cat&cat='.urlencode($catVideo);?>]]></video_listing_feed>
    <video_view_feed><![CDATA[<?php echo mopub_getPermalinkStructure().'type=article&article_id=';?>]]></video_view_feed>
    <audio_listing_feed><![CDATA[<?php echo mopub_getPermalinkStructure().'type=cat&cat='.urlencode($catAudio);?>]]></audio_listing_feed>
    <audio_view_feed><![CDATA[<?php echo mopub_getPermalinkStructure().'type=article&article_id=';?>]]></audio_view_feed>
    ...
    ?>
    <!--comments -->
    <comment_url><![CDATA[<?php echo mopub_getPermalinkStructure() . 'type=comment'; ?>]]></comment_url>
