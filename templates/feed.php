		...
		echo '<?xml version="1.0" encoding="UTF-8"?>'; ?>
				<rss version="2.0"> 
					<channel>
                        ...
                        $blogName = mopub_cleanGeneral( bloginfo('name')); 
                        
                        if($strictFiltering == 'enableFiltering' || empty($strictFiltering)) {
                            
                            $blogName = mopub_cleanContentStrict($blogName);
						...
						<generator><![CDATA[<?php echo $pluginName; ?>]]></generator>
							...
							while ($wp_query->have_posts()) : $wp_query->the_post(); 
								...
								<item>
                                    ...
                                    $itemTitle = mopub_cleanGeneral(get_the_title());
                                    
                                    if($strictFiltering == 'enableFiltering' || empty($strictFiltering)) {
                                        
                                        $itemTitle = mopub_cleanContentStrict($itemTitle);
                                    ...
                                    $description = mopub_cleanGeneral(get_the_excerpt()); 
                                    
                                    if($strictFiltering == 'enableFiltering' || empty($strictFiltering)) {
                                        
                                        $description = mopub_cleanContentStrict($description);
                                    ...
                                    $headline = mopub_cleanGeneral(get_the_title()); 
                                    
                                    if($strictFiltering == 'enableFiltering' || empty($strictFiltering)) {
                                        
                                        $headline = mopub_cleanContentStrict($headline);
                                    ...
                                    $abstract = mopub_cleanGeneral(get_the_excerpt()); 
                                    
                                    if($strictFiltering == 'enableFiltering' || empty($strictFiltering)) {
                                        
                                        $abstract = mopub_cleanContentStrict($abstract);
                                    ...
                                    <a_thumbnail><![CDATA[<?php
                                          ...
                                          if($thumbnail == '') {
                                               $matches = mopub_str_img_src(get_the_content());
                                                echo $matches[1][0];
                                          } else {
                                               echo $thumbnail;
                                          }
	...
	{     
			...
			foreach ( $tags as $key => $tag ) 
			{
				...
				<item>
                    ...
                    $itemName = mopub_cleanGeneral($tag->name); 
                    
                    if($strictFiltering == 'enableFiltering' || empty($strictFiltering)) {
                        
                        $itemName = mopub_cleanContentStrict($itemName);
		...
		$tags = get_terms('post_tag');
			...
			foreach($cats as $cat) {
				...
				<item>
                    ...
                    $itemTitle = mopub_cleanGeneral($cat->name); 
                    ...
                    $contentTitle = mopub_cleanGeneral($cat->name); 
                    ...
                    ?>
						<item>
                            ...
                            if($strictFiltering == 'enableFiltering' || empty($strictFiltering)) {
                                ...
                                $postTitle = mopub_cleanContentStrict($postTitle);
							...
							<?php 
                                ...
                                $content = mopub_cleanContent($my_post->post_content);



                                if($strictFiltering == 'enableFiltering' || empty($strictFiltering)) {
                                    
                                    $content = mopub_cleanContentStrict($content);
                                    
                                }
                                
                            ?>
							<description><![CDATA[<?php echo substr(mopub_cleanGeneral($content), 0, 200); ?>]]></description>
							<author><![CDATA[<?php echo the_author_meta('display_name', $my_post->post_author); ?>]]></author>
							<category><![CDATA[iPhone App]]></category>
                            ...
                            $abstract =  substr(mopub_cleanGeneral($my_post->post_content), 200); 
                            ...
                            <?php 
                                $matches = mopub_str_img_src($processedContent); 
                            ?>
							<a_images>
                            ...
                            <a_comments>
                                ...
                                <a_comment>
                                    ...
                                    <a_comment_content><![CDATA[<?php
                                        ...
                                        $comment = mopub_cleanContent($comment->comment_content, true);


                                        if($strictFiltering == 'enableFiltering' || empty($strictFiltering)) {

                                            $comment = mopub_cleanContentStrict($comment);
