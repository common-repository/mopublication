            ...
            if ($img.length > 0)
            {
                ...
                if(input_id == 'frm_topbar_logo') {
                    ...
                    if ( ! validateImageSize(input_id, url) ) {
                        tb_remove();
                        alert('The image you selected did not meet the minimum size requirements (620 x 88 pixels).' + "\n\n" +
                            "Make sure you are selecting 'Full Size' before clicking Insert into Post.");
                        return false;
                    }
                    
                } else if(input_id == 'frm_images_appicon') {
                    
                    if ( ! validateImageSize(input_id, url) ) {
                        tb_remove();
                        alert('The image you selected did not meet the minimum size requirements (1024 x 1024 pixels).' + "\n\n" +
                            "Make sure you are selecting 'Full Size' before clicking Insert into Post.");
                        return false;
                    }
